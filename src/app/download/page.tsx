  ...
  return (
    <div className="w-full h-screen p-6 bg-gray-50 text-gray-900 flex flex-col items-center justify-center">
      <div className="w-full flex items-center justify-center mt-[-3rem]">
        <div className="w-[3.8rem] h-[3.8rem] border-2 border-gray-400 rounded-full overflow-hidden mr-[2rem]">
          <Image 
            src={"/favicon.png"}
            alt="comming-soon"
            width={100}
      ...
      <h1 className="mt-[4rem] text-[1.5rem] animate-gradient text-gray-900">
        Comming Soon...
      </h1>
