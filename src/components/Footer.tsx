...
const Footer = () => {
  return (
    <div className="bg-gradient-to-t from-[#0f172a] via-[#1e293b] to-black w-full flex flex-col items-center justify-center p-4 px-6 pt-15  text-gray-100 mt-[12rem] footer-gradient">
